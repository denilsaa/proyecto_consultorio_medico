...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-48 h-screen pt-20 transition-transform -translate-x-full border-r border-gray-200 sm:translate-x-0 dark:bg-[#245e7f] dark:border-gray-700 bg-[#2B32B2]" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto dark:bg-[#245e7f] bg-[#2B32B2]">
