    ...
    <div class="relative overflow-x-auto shadow-2xl shadow-black dark:shadow-neutral-300 sm:rounded-lg ">
        <div class="relative overflow-x-auto shadow-2xl shadow-black dark:shadow-white sm:rounded-lg">
            <div class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <div class="px-5 pt-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                ...
                <div class="w-full p-3">
                    <div class="mx-auto">
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-5">
                            ...
                            <div class="col-span-2">
                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Paciente</label>
                    ...
                    <div class="mx-auto ml-1">
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-5">
                            <!-- dIAGNOSTICO -->
                            <div class="col-span-5">
                                <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Diagnostico</label>
                                <textarea id="message" rows="3" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Describe los Motivos de la consulta ...."></textarea>
                            </div>
                        </div>
                    </div>
