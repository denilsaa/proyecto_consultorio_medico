...
<table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
    ...
    <caption class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
        ...
        <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0">
            <!-- buscador -->
            <div class="">
                <label for="buscar_farmaco" class="sr-only">Search</label>
                <div class="relative mt-1">
                    ...
                    <input type="text" id="buscar_farmaco" class="block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar Farmaco">
                </div>
            </div>
            <!-- Acciones -->
            <div class="ml-2">
            ...
            <div class="ml-2">
                ...
                <div>
                    <x-formularios.form-farmaco></x-formularios.form-farmaco>
                </div>
            </div>
        </div>
    </caption>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4 text-center" colspan="{{ count($cabeceras) + 1 }}">
                    <div class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                        ...
                        <div>
                            <span class="font-medium">Alerta !</span> No hay farmacos registrados.
                        </div>
                    </div>
