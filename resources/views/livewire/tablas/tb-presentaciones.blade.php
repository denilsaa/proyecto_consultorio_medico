    ...
    <caption class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
        ...
        <div class="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0">
            ...
            <div class="ml-2">
                ...
                <div>
                    <x-formularios.form-presentacion></x-formularios.form-presentacion>
                </div>
            </div>
        </div>
    </caption>
    ...
    <tbody>
        @foreach($presentaciones as $presentacion)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="p-4">
                    <div class="flex items-center">
                        <input id="checkbox-{{ $presentacion->id }}" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="checkbox-{{ $presentacion->id }}" class="sr-only">checkbox</label>
                    </div>
                </td>
                <!-- Nombre -->
                <td class="px-6 py-4">
