...
<table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
    ...
    <x-componentes.tb-encabezado titulo="Pacientes">
        <x-slot name="icono">
            ...
            @foreach($pacientes as $paciente)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                        ...
                        <div class="ps-3">
                            <!-- Nombre -->
                            <div class="text-base font-semibold">{{$paciente->usuario->nombre}}</div>
                            <!-- Correo -->
                            <div class="font-normal text-gray-500">{{$paciente->usuario->correo}}</div>
                        </div>
                    </th>
                    <!-- Carnet -->
                    <td class="px-6 py-4">
                        {{$paciente->usuario->carnet}}
                    </td>
                    <!-- telefono -->
                    <td class="px-6 py-4">
                    ...
                    <!-- estado -->
                    <td class="px-6 py-4">
                        @if($paciente->usuario->estado_usuario )
                        <div class="flex items-center">
